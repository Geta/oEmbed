...
$fxPackage = Get-package | where-object { $_.id -eq "EPiServer.Framework"} | select-object -first 1
$cmsPackage = Get-package | where-object { $_.id -eq "EPiServer.Core"} | select-object -first 1
$fxTools =[System.IO.Path]::Combine( $installPath,  ".." , $fxPackage.Id + "." + $fxPackage.Version , "tools")
$cmsUpgradePath =[System.IO.Path]::Combine($installPath, "tools\upgrade")
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU7Aw5XGkVzhBBMZxnKDEgXLF5
# 9legghP/MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSHPJVHOhrjx87cFbVF8bOFZ/os
# 4TANBgkqhkiG9w0BAQEFAASCAQAuNRd36FW8MBejdfpM7Ku4gS3Gel8WcPy8oEk6
# hZ66VWHu9hhMgVKszUAELIsDBWL4z46CLF1FjYM8PlLW8WROyzvuRiji5x0WjMEy
# kfLPPCUZWRqFML+bK0lH/0xzwh2OO8p2/Wp4oU5t40vKJ2S4e7SQRBTh03VjEoYc
# pFMKo1SUP3LPUJON9eR6HCetaIFUHAWXphxzNDLEnje4LyIeTJsATkMEtL+B5iof
# gLOXjUm6ITjiHf4Nt2U3hxLnHagcJgzU6Oe2zyBg94XRFvu1VYq/4OAcxLDxxkDB
# UFVLjog7DEnsnsYB9T141t/1I/UqP2TznmRgBnpH3jiqfS7roYICCzCCAgcGCSqG
...
# MDIyODA3NTIyMVowIwYJKoZIhvcNAQkEMRYEFH1lwFvQDpUbOn5NXSg5MTxQJBAY
# MA0GCSqGSIb3DQEBAQUABIIBAC8SJJqZeU0EQ14sR0mMjsJI4l1r+7n5rQqTo6ru
# Un0IScWHd0obi7LoCjZV8pfe4G3D8da4uoabwSJ90lFOLEBzp35xEbtWywVBW8Y5
# fsJlbm87Gu9YkzKT3vbyubV3N6GMqxrfHIAd9QraskIKkVhvdqB7M+hbwMaoK5aD
# pX5Dj3DYEQo67BO9yBFXyJPSRg6ZUVluYj8H3bBtm2zOqvm1CTjy2QDOHcv52Q6s
# Lr9CreHEg6ctHYXc3yErTn5PRmuzYcDLgNXZbpqb1neu6NAX+m7/sU7MIHhYjR37
# z+uEvtgBeKPbAj+8piYpr8rkCejdZx7hDgyCLq3XmgkBPPI=
